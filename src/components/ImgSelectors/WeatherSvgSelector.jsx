        ...
        case '11n': // 'thunderstorm'
            return (
                <svg 
                    ...
                    viewBox="0 0 48 48">
                    <path 
                        d="M5.8,38l2.1-5c0.3-0.8,0-1.6-0.8-2s-1.6,0-2,0.8l-2.1,5c-0.3,0.8,0,1.6,0.8,2S5.5,38.8,5.8,38z M13.8,40l2.1-5
                    ...
                    <path d="M15.3,12.3c0,5.6,4.5,10.1,10.1,10.1c5.1,0,9.3-3.7,10-8.6c0.7-0.3,1.5-0.4,2.4-0.4c3.7,0,6.8,3,6.8,6.8
                        ...
                        fill="url(#SVGID_1_)"/>
                    <path d="M14.1,39.9" fillRule="evenodd" clipRule="evenodd" fill="#FEEA32"/>
                    <path d="M23.6,24.8l7-19.2L14.1,29.2h6.3l-5.2,18.2l14.5-22.7H23.6z" fillRule="evenodd" clipRule="evenodd" fill="#FEEA32"/>
                </svg>
            );
        case '13d':
        case '13n': // 'snow'
